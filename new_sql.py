...
def execute_sql_scripts_in_order(server, database, username, password, list_file_path, sql_dir, local_output_directory,final_output_directory):
    conn = None
    try:
        ...
        for script_name in sql_scripts:
            ...
            csv_file_path = os.path.join(local_output_directory, csv_file_name)
            ...
            with open(csv_file_path, 'w', newline='') as csv_file:
                ...
                for statement in parsed_script:
                    ...
                    if cursor.description is not None or None:
                        # Fetch column names
            ...
            zip_file_name = f'{local_output_directory}/{sql_file_name}-{date_string}-{time_string}.zip'
        ...
        for zip_file in os.listdir(local_output_directory):
            if zip_file.endswith(".zip"):
                zip_file_path = os.path.join(local_output_directory, zip_file)
                final_zip_file_path = os.path.join(final_output_directory, zip_file)
...
local_output_directory = '/home/subhajit/Desktop/open/local_output'
final_output_directory = '/home/subhajit/Desktop/open/output'
execute_sql_scripts_in_order(server, database, username, password, list_file_path, sql_dir, local_output_directory,final_output_directory)
